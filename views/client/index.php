  ...
  <style>
    ...
    .hero {
      ...
      background:
        ...
        <?php
        // Environment-aware background image path
        require_once 'config.php';
        if (env_is_localhost()) {
            echo "url('../../../public/assets/Banner2.png')";
        } else {
            echo "url('../../../public/assets/Banner2.png')";
        }
    ...
    .card:hover {
     ...
     /* Force spacing between business card rows */
    #businessList .col-12,
    #businessList .col-sm-6,
    #businessList .col-md-4, 
    #businessList .col-lg-3 {
      margin-bottom: 1rem !important;
      padding-bottom: 1rem !important;
    }

    /* Additional spacing for business cards container */
    #businessList .row > [class*="col-"] {
      margin-bottom: 1rem !important;
    }
...
<body>
    ...
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="#">
        <img 
          src="<?php
          if (env_is_localhost()) {
              echo '../../../public/assets/APPLOQIC-LOGO-HORIZONTAL---WHITE.png';
          } else {
              echo '../../../public/assets/APPLOQIC-LOGO-HORIZONTAL---WHITE.png';
          }
          ?>" 
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content glass-modal p-4">
        ...
        <div class="modal-body text-white">
          <p><strong>Phone:</strong> +60 19-888 8398</p>
          <p><strong>Office Number:</strong> +60 89-227 227</p>
          <p><strong>Email:</strong> info@apploqic.my</p>
          <p><strong>Address:</strong> Lot 1, Blok A Tkt 1 Batu 4, Jln Lintas Selatan,</p>
          <p>Taman Indah Jaya, 90000 Sandakan, Sabah.(HQ)</p>
  ...
  // Determine the correct base path for the current request
  $currentPath = $_SERVER['REQUEST_URI'] ?? '';
  $isDirectAccess = strpos($currentPath, '/views/client/') !== false;
  $basePath = $isDirectAccess ? '' : 'views/client/';
  
  echo "window.ENV_CONFIG = {";
  echo "  environment: '" . ClientConfig::getEnvironment() . "',";
  echo "  isLocalhost: " . (env_is_localhost() ? 'true' : 'false') . ",";
  echo "  apiBaseUrl: '" . env_api_url() . "',";
  echo "  searchApiUrl: '" . env_search_api_url() . "',";
  ...
  <?php
  // Determine the correct path for JavaScript file
  $currentPath = $_SERVER['REQUEST_URI'] ?? '';
  $isDirectAccess = strpos($currentPath, '/views/client/') !== false;
  ...
  if (env_is_localhost()) {
    if ($isDirectAccess) {
      ...
      echo '<script src="views/client/js/client.js"></script>';
    }
  } else {
